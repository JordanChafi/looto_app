...
import 'package:looto_app/controller/auth_controller.dart';
import 'package:looto_app/utils/app_colors.dart';
import 'package:looto_app/views/driver/car_registration/pages/document_uploaded_page.dart';
import 'package:looto_app/views/driver/car_registration/pages/location_page.dart';
import 'package:looto_app/views/driver/car_registration/pages/upload_document_page.dart';
import 'package:looto_app/views/driver/car_registration/pages/vehical_color_page.dart';
import 'package:looto_app/views/driver/car_registration/pages/vehical_make.dart';
import 'package:looto_app/views/driver/car_registration/pages/vehical_model_page.dart';
import 'package:looto_app/views/driver/car_registration/pages/vehical_model_year_page.dart';
import 'package:looto_app/views/driver/car_registration/pages/vehical_number_page.dart';
import 'package:looto_app/views/driver/car_registration/pages/vehical_type_page.dart';
